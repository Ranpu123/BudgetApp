...
class FExpenseBottomSheetViewModelTest: KoinTest{

    private var context: Context = mockk(relaxed = true)
    private lateinit var viewModel: FExpenseBottomSheetViewModel
    private val repository: IFixedExpenseRepository = mockk(relaxed = true)
